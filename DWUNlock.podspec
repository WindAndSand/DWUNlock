#
#  Be sure to run `pod spec lint DWUNlock.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "DWUNlock"
  s.version      = "0.0.1"
  s.summary      = "A short description of DWUNlock."
  ...
  # Or just: s.author    = "dwanghell"
  # s.authors            = { "dwanghell" => "dwang.hello@outlook.com" }
  # s.social_media_url   = "http://twitter.com/dwanghell"
